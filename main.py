from fastapi import FastAPI, HTTPException
  ...
  def score_lead(lead: LeadInput):
      """
      Score an HVAC lead based on sophistication signals

      Scoring logic:
      - Service software: +15 points
      - Franchise: +10 points
      - Reviews (non-franchise): +10 (500+), +7 (100-499), +4 (25-99), +2 (10-24)
      - LinkedIn: +3 points
      - Domain: +2 points
      """
      try:
